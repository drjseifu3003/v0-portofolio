...
export const studies: Study[] = [
  ...
  {
    slug: "first-aid-rag-ai",
    title: "First Aid RAG AI",
    listResultLine: "Gemini Vision . LangGraph Orchestration . Safety-First RAG . 100% Escalation Recall",
    subtitle: "A safety-critical decision-support first aid bot with multimodal symptoms triage and automated safety gates",
    tag: "Case Study 09 - Healthcare AI & Systems",
    image: "/images/case-study/thumb-first-aid-rag-ai.png",
    publishedAt: "2026",
    overview: [
    ...
    stack: [
      { layer: "Workflow Engine", tech: "LangGraph (Python)" },
      { layer: "AI & Vision Model", tech: "Gemini 2.5 Flash" },
      { layer: "Vector Database", tech: "Qdrant (Scenarios & Corrections)" },
      { layer: "Primary Datastore", tech: "PostgreSQL (SQLAlchemy)" },
      { layer: "Interface", tech: "Telegram Bot API" },
      { layer: "Testing Frame", tech: "Pytest (Deterministic Evaluation Harness)" },
    ],
    results: [
      { value: "100%", label: "Escalation recall" },
      { value: "0%", label: "Paraphrasing of steps" },
      { value: "< 2.5s", label: "End-to-end latency" },
      { value: "100%", label: "Deterministic safety" },
    ],
    resultBullets: [
  ...
  },
  {
    ...
    results: [
      { value: "8+", label: "Epidemics indexed" },
      { value: "100%", label: "Notifiable disease recall" },
      { value: "< 2.0s", label: "Triage latency" },
      { value: "Vet-Reviewed", label: "Knowledge base validation" },
    ],
    resultBullets: [
